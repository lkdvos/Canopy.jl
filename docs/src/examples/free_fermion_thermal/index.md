```@meta
EditURL = "../../../../examples/free_fermion_thermal/main.jl"
```
...
````
exact_thermal (generic function with 1 method)
````
...
````
beta_sweep (generic function with 1 method)
````
...
````
ring_degrees (generic function with 1 method)
````
